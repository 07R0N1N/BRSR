  ...
  return (
    <section>
      ...
      <div className="mt-8">
        ...
        <p className="mt-3 text-xs font-semibold text-gray-700">21. Participation/Inclusion of women</p>
        <div className="mt-2 overflow-x-auto">
        ...
        <p className="mt-3 text-xs font-semibold text-gray-700">22. Turnover rate for permanent employees and workers (past 3 years)</p>
        <div className="mt-2 overflow-x-auto">
