...
export function PanelGeneralData({ values, calcDisplay, onChange }: Props) {
  ...
  const calcCell = (displayValue: string) => (
    <td
      className="border border-gray-200 px-3 py-2.5 font-mono calc-cell"
      role="status"
      aria-readonly="true"
    >
      {displayValue || "—"}
  ...
  return (
    <section>
      ...
      <div className="mt-6">
        <h3 className="text-sm font-medium text-indigo-600">Turnover & PPP (for intensity calculations)</h3>
          ...
          <tbody>
            ...
            <tr>
              <td className="border border-gray-200 px-3 py-2.5">
                ...
                <br />
                <small className="text-gray-400">Revenue ÷ PPP factor</small>
              </td>
      ...
      <div className="mt-6">
        <h3 className="text-sm font-medium text-indigo-600">Employee & worker counts (for use across principles)</h3>
        ...
        <table className="mt-2 w-full max-w-3xl border-collapse border border-gray-200 text-sm">
          <thead>
            <tr className="bg-gray-50">
              <th className="border border-gray-200 px-3 py-2.5 text-left">Category</th>
              <th className="border border-gray-200 px-3 py-2.5 text-left">Male</th>
              <th className="border border-gray-200 px-3 py-2.5 text-left">Female</th>
              <th className="border border-gray-200 px-3 py-2.5 text-left">Others</th>
              <th className="border border-gray-200 px-3 py-2.5 text-left">Total (calc)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className="border border-gray-200 px-3 py-2.5">Employees – Permanent</td>
              <td className="border border-gray-200 px-3 py-2.5">
            ...
            <tr>
              <td className="border border-gray-200 px-3 py-2.5">Employees – Other than permanent</td>
              <td className="border border-gray-200 px-3 py-2.5">
            ...
            <tr>
              <td className="border border-gray-200 px-3 py-2.5">Workers – Permanent</td>
              <td className="border border-gray-200 px-3 py-2.5">
            ...
            <tr>
              <td className="border border-gray-200 px-3 py-2.5">Workers – Other than permanent</td>
              <td className="border border-gray-200 px-3 py-2.5">
